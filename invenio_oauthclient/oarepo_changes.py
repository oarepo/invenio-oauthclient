...
features_incorporated = '[{"name":"refresh-token-from-5.1.0","base":"v5.1.0"}]'

oarepo_major_version = "12"

package_oarepo_version = "oarepo-5.1.0"

configuration = '{"name": "invenio-oauthclient", "oarepo": 13, "features": [{"name": "refresh-token-from-5.1.0", "base": "v5.1.0"}], "package": "invenio-oauthclient", "invenio_version": "5.1.0", "version": "5.1.0"}'
