...
features_incorporated = '[{"name":"refresh-token-from-v4.0.2","base":"v4.0.2"}]'

oarepo_major_version = "12"

package_oarepo_version = "oarepo-4.2.0"

configuration = '{"name": "invenio-oauthclient", "oarepo": 12, "features": [{"name": "refresh-token-from-v4.0.2", "base": "v4.0.2"}], "package": "invenio-oauthclient", "invenio_version": "4.2.0", "version": "4.2.0"}'
